...
xtag.register('kano-password-field', {
    content: function () {/*
        <div class="kano-password-field">
            ...
            <div class="password-field">
                <div class='password-indicator show-password' id='passwordIndicator'></div>
    ...
    */
    ...
    lifecycle: {
        ...
        inserted: function () {
            var indicator = xtag.query(this, '#passwordIndicator')[0];
            xtag.addEvent(indicator, 'click', function () {
                indicator.classList.toggle('show-password');
                indicator.classList.toggle('hide-password');
