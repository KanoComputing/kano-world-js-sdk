    ...
    xtag.register('kano-login-form', {
        content: function () {/*
            <form id="form">
                ...
                <hr/>
                <div class="actions">
                    <a id="signup-link" href class="small">Sign up</a><span class="small"> - </span><a href="/reset-password" class="small">Forgot your password?</a>
                </div>
            </form>
        */},
        lifecycle: {
            ...
            inserted: function () {
                ...
                xtag.addEvent(this.signupLink, 'tap', function () {
